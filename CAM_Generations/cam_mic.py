...
checkpoint_path = "output/checkpoint_no_mri.pth"
...
if __name__ == "__main__":
    ...
    for batch in trainloader:
        ...
        for idx in range(x_input.shape[0]):
            ...
            plt.tight_layout()
            save_path = f"cam_outputs/mic/{prefix}_9x4_{patient_id[idx]}_{idx}.png"
            os.makedirs("cam_outputs/mic", exist_ok=True)
